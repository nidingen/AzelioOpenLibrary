...
equation
  ...
  P_WF = der(E_WF);
  annotation(Documentation(info = "<p>This block simulates the power and energy output (<em>P<sub>WF</sub>, E<sub>WF</sub></em>) of a windfarm, by accounting for array losses [1, 2].&nbsp;</p>
...
<p>where <em>a<sub>1</sub>, ..., a<sub>4</sub></em> are the polynomial coefficients and <em>CWS<sub>D</sub></em> is the crosswind spacing-rotor diameter ratio.</p>
<p style=\"text-align: center;\">Figure 1</p>
<p><img style=\"display: block; margin-left: auto; margin-right: auto;\" src=\"Array losses.jpg\" alt=\"\" width=\"451\" height=\"289\" /></p>
