...
block Vestas_V110 "Table look-up in one dimension (matrix/file) with one input and n outputs"
  ...
  parameter Real table[:, :] = {{0.0, 0.0}, {3.0, 0}, {3.5, 0.254}, {4.0, 0.379}, {4.5, 0.407}, {5.0, 0.433}, {5.5, 0.438}, {6.0, 0.46}, {6.5, 0.461}, {7.0, 0.449}, {7.5, 0.447}, {8.0, 0.442}, {8.5, 0.452}, {9.0, 0.439}, {9.5, 0.43}, {10.0, 0.408}, {10.5, 0.389}, {11.0, 0.361}, {11.5, 0.327}, {12.0, 0.296}, {12.5, 0.262}, {13.0, 0.234}, {13.5, 0.211}, {14.0, 0.188}, {14.5, 0.168}, {15.0, 0.153}, {15.5, 0.139}, {16.0, 0.128}, {16.5, 0.116}, {25, 0}} "Table matrix (grid = first column; e.g., table=[0,2])" annotation(Dialog(group = "Table data definition", enable = not tableOnFile));
