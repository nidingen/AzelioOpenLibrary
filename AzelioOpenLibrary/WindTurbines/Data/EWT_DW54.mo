...
block EWT_DW54 "Table look-up in one dimension (matrix/file) with one input and n outputs"
  ...
  parameter Real table[:, :] = {{0.0, 0.0}, {1.474201474, 0.0}, {1.781326781, 0.091}, {2.14987715, 0.2}, {2.518427518, 0.292}, {3.071253071, 0.403}, {4.115479115, 0.484}, {5.036855037, 0.484}, {7.125307125, 0.495}, {8.906633907, 0.508}, {9.398034398, 0.493}, {9.459459459, 0.347}, {10.01228501, 0.291}, {10.68796069, 0.244}, {11.48648649, 0.200}, {12.59213759, 0.161}, {13.6977887, 0.130}, {14.98771499, 0.106}, {15.97051597, 0.086}, {17.07616708, 0.069}, {18.73464373, 0.049}, {20.33169533, 0.035}, {22.11302211, 0.025}, {23.77149877, 0.014}, {25.0, 0.0}} "Table matrix (grid = first column; e.g., table=[0,2])" annotation(Dialog(group = "Table data definition", enable = not tableOnFile));
