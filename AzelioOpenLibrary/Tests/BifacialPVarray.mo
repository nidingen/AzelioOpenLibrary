...
model BifacialPVarray
  ...
  Modelica.Blocks.Tables.CombiTable1Ds TMY(tableOnFile = true, tableName = "TMY", fileName = "TMY_2005.txt", columns = 2:9) annotation(Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
